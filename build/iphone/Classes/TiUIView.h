...
/**
 Base class for all mobile_test views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the mobile_test view hierarchy (such as wrapped iOS UIViews) was touched.
