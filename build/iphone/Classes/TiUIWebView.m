...
static NSString * const kmobile_testJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_mobile_testInjection
{
	...
	[html appendString:kmobile_testJavascript];
...
{
	// attempt to make well-formed HTML and inject in our mobile_test bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _mobile_testInjection]];
