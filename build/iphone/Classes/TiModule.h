...
/**
 The base class for all mobile_test modules
 */
...
/**
 mobile_test Platform calls this method on startup.
 */
-(void)startup;

/**
 mobile_test Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 mobile_test Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 mobile_test Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 mobile_test Platform calls this method on resume.
 @param sender The sender of the event.
 */
