...
@interface mobile_testObject : KrollCoverageObject {
#else
@interface mobile_testObject : KrollObject {
#endif
@private
...
extern NSString * mobile_test$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	mobile_testObject *_mobile_test;
    KrollObject* console;
	BOOL shutdown;
