 ...
 * Copyright (c) 2009-2011 by mobile_test, Inc. All Rights Reserved.
...
//@interface mobile_testObject : NSObject
//@end

@interface mobile_testObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[mobile_testObject class]])
		{
			for (NSString *key in [[(mobile_testObject*)o modules] allKeys])
			{
