...
// in simulator we redefine to format for mobile_test Developer console
...
{\
	NSString * exceptionName = [@"org.mobile_test." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mobile_test";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UImobile_testNativeItemNone = -1, 
	UImobile_testNativeItemSpinner = -2,
	UImobile_testNativeItemProgressBar = -3,
	
	UImobile_testNativeItemSlider = -4,
	UImobile_testNativeItemSwitch = -5,
	UImobile_testNativeItemMultiButton = -6,
	UImobile_testNativeItemSegmented = -7,
	
	UImobile_testNativeItemTextView = -8,
	UImobile_testNativeItemTextField = -9,
	UImobile_testNativeItemSearchBar = -10,
	
	UImobile_testNativeItemPicker = -11,
	UImobile_testNativeItemDatePicker = -12,
	
	UImobile_testNativeItemInfoLight = -13,
	UImobile_testNativeItemInfoDark = -14,
	
	UImobile_testNativeItemDisclosure = -15,
	
	UImobile_testNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all mobile_test instances of
